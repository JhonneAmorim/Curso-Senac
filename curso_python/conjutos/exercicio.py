...
def encontrar_numero_duplicado(lista_inteiros):
    numeros_checado = set()
    numeros_duplicado = -1

    for numero in lista_inteiros:
        if numero in numeros_checado:
            numeros_duplicado = numero
            break

        numeros_checado.add(numero)
    
    return numeros_duplicado
                
for lista in lista_de_listas_de_inteiros:
    print(lista, encontrar_numero_duplicado(lista))
